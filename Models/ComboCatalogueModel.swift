import Foundation
import ObjectMapper
class ComboCatalogueModel : NSObject, NSCoding, Mappable{

    var data : [ComboCatalogueData]?
    var message : String?
    var success : Bool?


    class func newInstance(map: Map) -> Mappable?{
        return ComboCatalogueModel()
    }
    ...
    {
         data = aDecoder.decodeObject(forKey: "data") as? [ComboCatalogueData]
...
class ComboCatalogueData : NSObject, NSCoding, Mappable{
